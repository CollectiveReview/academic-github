    ...
    <div className="w-full bg-gray-100 p-1 shadow flex flex-row justify-between fixed items-center">
      <div className="flex items-centner m-2">
        ...
        <div className="flex px-3 items-center">
          <h5 className="text-gray-500">Porous...</h5>
          <div className="mx-2 flex h-full items-center">
            <ArrowBackIosIcon className="text-gray-500 w-4 h-4" />
            <ArrowForwardIosIcon className="text-gray-500 w-4 h-4" />
          </div>
      ...
      <div className="md:block hidden h-full items-center ">
        <div className="flex space-x-3 items-center h-full m-2 ">
          <div className="flex items-center h-full">
            <SearchInput placeholder="Shrinkage" />
          </div>
          {user ? (
            <div>
              <ProfileMenu />
